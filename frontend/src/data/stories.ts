...
export const stories = [
    ...
    },
    {
        ...
        content: `
            ...
            <img src="https://images.unsplash.com/photo-1594708767771-a7502209ff51?w=1200&q=80" alt="Fresh meals prepared for children" style="width: 100%; border-radius: 12px; margin: 2rem 0; box-shadow: 0 10px 30px -10px rgba(0,0,0,0.1);" />
            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 1rem; margin: 2rem 0;">
                <img src="https://images.unsplash.com/photo-1589187151032-573a91317445?w=800&q=80" alt="Authentic fresh ingredients" style="width: 100%; height: 100%; object-fit: cover; border-radius: 12px; margin: 0;" />
                <img src="https://images.unsplash.com/photo-1541813064842-4d8cc00b39aa?w=800&q=80" alt="Smiling children with food" style="width: 100%; height: 100%; object-fit: cover; border-radius: 12px; margin: 0;" />
            </div>
