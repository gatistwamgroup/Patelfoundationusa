    ...
    <div class="email-container">
      ...
      <div class="header">
        <div class="logo-container">
          <img src="cid:logo" alt="Patel Foundation" width="160" style="display: block; margin: 0 auto;">
        </div>
    ...
    <div class="email-container">
      ...
      <div class="header">
        <div style="margin-bottom: 20px;">
          <img src="cid:logo" alt="Patel Foundation" width="120" style="display: block;">
        </div>
  ...
  <div class="email-wrapper">
    <div class="container">
      <div style="margin-bottom: 30px;">
        <img src="cid:logo" alt="Patel Foundation" width="180" style="display: block; margin: 0 auto;">
      </div>
